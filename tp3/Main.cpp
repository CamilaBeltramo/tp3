...
int main() {
	...
	cCamioneta* camio = new cCamioneta(5, "verde", fecha1, 8675, "AC403DM", 1234, 25000, 1, 1);
	cAuto* aut = new cAuto(4, "rojo", fecha2, 8472, "AC402DF", 4567, 30000, 1);
	cMoto* mot = new cMoto(2, "negra", fecha3, 8968, "AC469DF", 2587, 20000, 2);
	cTrafic* traf = new cTrafic(6, "azul", fecha4, 8325, "AC789DM", 7894, 35000, 2, 1);
